...
},
{
  ...
  id: 38,
  option_1: { text: "Drag the wounded <span class='gender'></span> into the pharmacy aisle", step: MAX },
...
},
{
  ...
  option_2: { text: "Help the stranger", step: 44, conditional: 'bread'  }, // you attack with wine
...
},
{
  ...
  id: 52,
  option_1: { text: "Take <span class='name'></span>", step: MAX },
...
},
{
  ...
  id: 53,
  option_1: { text: "Raise the arm", step: MAX },
  option_2: { text: "Keep adding cloth and gauze to the material", step: MAX },
  option_3: { text: "Remove bloody cloth and replace with new material", step: MAX },
},
{
  char_addition1: 'arm',
